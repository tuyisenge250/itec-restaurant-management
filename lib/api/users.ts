...
export type User = { id: string; name: string; email: string; role: 'admin' | 'kitchen' | 'waiter'; isActive: boolean; createdAt: string }
export type CreateUserInput = { name: string; email: string; password: string; role: 'admin' | 'kitchen' | 'waiter' }
